...
class BusinessReport {
    ...
    public static Map<Disability, List<Employee>> getEmployeesOnSameDisability(Business business) {
        ...
        Map<Disability, List<Employee>> disabilityMap =
                business.getEmployees().stream().collect(Collectors.groupingBy(e -> e.getDisability()));
    ...
    public static long getNumberOfDifferentProjectsWorkedByCurrentFemaleEmployees(Business business) {
        ...
        List<Employee> femaleEmployees = business.getEmployees().stream()
                .filter(e -> e.getGender().equals(Gender.FEMALE)).toList();
    ...
    public static Map<Religion, Map<Gender, List<Employee>>> getEmployeesOnSameReligionAndGender(Business business) {
        ...
        Map<Religion, List<Employee>> religionMap =
                business.getEmployees().stream().collect(Collectors.groupingBy(e -> e.getReligion()));
        ...
        for (Map.Entry<Religion, List<Employee>> entry : religionMap.entrySet()) {
            religionGenderMap.put(entry.getKey(),
                    entry.getValue().stream().collect(Collectors.groupingBy(e -> e.getGender())));
        }
